...
<!--header-->
	@include('template.section.headerweb')
		...
		<!---->
			<div class="container">
				<hr>
				<a href="{{url('products')}}" class="btn btn-default"><i class="mdi mdi-exit-to-app"></i>Kembali</a>
		<div class="single">
		<div class="col-md-9">
				...
				<ul id="etalage">
							...
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image img-responsive" src="{{url('public')}}/images/me6.png" alt="" >
									<img class="etalage_source_image img-responsive" src="{{url('public')}}/images/me6.png" alt="" >
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image img-responsive" src="{{url('public')}}/images/me6.png" alt="" >
